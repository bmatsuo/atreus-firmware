...
int layer0[44] = {
    ...
    KEY_QUOTE, SHIFT(KEY_QUOTE), KEYBOARD_LEFT_GUI, KEYBOARD_LEFT_SHIFT, KEYBOARD_LEFT_CTRL, KEYBOARD_LEFT_ALT, KEY_SPACE, PRE_FUNCTION(1), KEY_BACKSLASH, KEY_LEFT_BRACE, KEY_BACKSPACE };
...
int layer1[44] = {
    ...
    KEY_ESC, SHIFT(KEY_7), KEY_MINUS, KEY_EQUAL, SHIFT(KEY_QUOTE), KEY_ENTER, KEY_QUOTE, KEY_1, KEY_2, KEY_3, KEY_TAB,
    FUNCTION(2), SHIFT(KEY_INSERT), KEYBOARD_LEFT_GUI, KEYBOARD_LEFT_SHIFT, KEYBOARD_LEFT_CTRL, KEYBOARD_LEFT_ALT, KEY_SPACE, PRE_FUNCTION(1), KEY_0, KEY_E, KEY_ENTER };
...
int layer3[44] = {
    ...
    KEY_MINUS, SHIFT(KEY_MINUS), KEYBOARD_LEFT_GUI, KEYBOARD_LEFT_SHIFT, KEYBOARD_LEFT_CTRL, KEYBOARD_LEFT_ALT, KEY_SPACE, PRE_FUNCTION(1), KEY_MINUS, KEY_SLASH, KEY_BACKSPACE };
...
int layer4[44] = {
    ...
    KEY_ESC, SHIFT(KEY_7), KEY_LEFT_BRACE, KEY_RIGHT_BRACE, SHIFT(KEY_MINUS), KEYBOARD_LEFT_ALT, KEY_MINUS, KEY_1, KEY_2, KEY_3, KEY_TAB,
    FUNCTION(2), SHIFT(KEY_INSERT), KEYBOARD_LEFT_GUI, KEYBOARD_LEFT_SHIFT, KEY_BACKSPACE, KEYBOARD_LEFT_CTRL, KEY_SPACE, PRE_FUNCTION(1), KEY_0, KEY_PERIOD, KEY_ENTER };
