...
int layer0[44] = {
    ...
    KEY_TAB, KEY_ESC, KEYBOARD_LEFT_GUI, KEYBOARD_LEFT_SHIFT, KEYBOARD_LEFT_CTRL, KEYBOARD_LEFT_ALT, KEY_SPACE, PRE_FUNCTION(1), KEY_QUOTE, KEY_LEFT_BRACE, KEY_BACKSPACE };
...
int layer1[44] = {
    ...
    SHIFT(KEY_5), SHIFT(KEY_6), KEY_MINUS, KEY_EQUAL, KEY_TILDE, KEY_ENTER, SHIFT(KEY_7), KEY_1, KEY_2, KEY_3, KEY_BACKSLASH,
    FUNCTION(2), SHIFT(KEY_INSERT), KEYBOARD_LEFT_GUI, KEYBOARD_LEFT_SHIFT, KEYBOARD_LEFT_CTRL, KEYBOARD_LEFT_ALT, KEY_SPACE, PRE_FUNCTION(1), KEY_E, KEY_0, KEY_RIGHT_BRACE };
