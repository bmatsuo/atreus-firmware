...
int layer0[44] = {
    ...
    KEY_TAB, KEY_ESC, KEYBOARD_LEFT_GUI, KEYBOARD_LEFT_SHIFT, KEYBOARD_LEFT_CTRL, KEYBOARD_LEFT_ALT, KEY_SPACE, PRE_FUNCTION(1), KEY_BACKSLASH, KEY_LEFT_BRACE, KEY_BACKSPACE };
...
int layer3[44] = {
    ...
    KEY_TAB, KEY_ESC, KEYBOARD_LEFT_GUI, KEYBOARD_LEFT_SHIFT, KEYBOARD_LEFT_CTRL, KEYBOARD_LEFT_ALT, KEY_SPACE, PRE_FUNCTION(1), KEY_MINUS, KEY_SLASH, KEY_BACKSPACE };
